...
class YoloDataset(data.Dataset):
    ...
    def __init__(self, root, list_file, train, transform):
        ...
        # 如果list_file是一个list的时候，代表有多个file，合并到一起
        ...
        # self.boxes代表的是所有的物体框，形如[[x,y,x2,y2],[x,y,x2,y2],...,[x,y,x2,y2]]
        # labels则是对应的类别标签[[1],[2],[4],[6]...]
    ...
    def __getitem__(self, idx):
        ...
        img = cv2.resize(img, (self.image_size, self.image_size))  # resize图像大小
